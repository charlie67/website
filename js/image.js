var mobileCheckAnswer = window.mobilecheck();

var afterDiv = document.getElementById('after-intro');
afterDiv.style.visibility = 'hidden';

if (!mobileCheckAnswer){
  window.onload = init;
...
function init() {
  ...
  var tl = new TimelineMax({
    ...
    yoyo: true,
    onComplete: function() {
      window.setTimeout(endAnimation, 1200);
  }
  });
